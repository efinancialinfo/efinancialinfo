...
const CommitmentToExcellence = () => {
  ...
  return (
    <section className="bg-[#edf7f4] py-16 mb-20">
      <div className="container mx-auto px-4 text-center">
        <h1 className="md:text-4xl mb-16 text-4xl text-gray-900 leading-[120%] font-bold font-inter uppercase">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 cursor-pointer">
          {features.map((item, index) => (
            ...
            >
              <div className="bg-[#1f4e3d] p-4 rounded-full mb-6 transition-transform duration-300 group-hover:rotate-12">
                <Image
                  src={item.icon}
                  alt={item.label}
                  width={60}
